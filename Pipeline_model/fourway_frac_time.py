...
continent_no = 2
mode = 0
Model_Dir = '/home/kumarv/pravirat/Realsat_labelling/river_code_kx/Model/FourWay_frac_time/'
continent_no_ASIA = 1
continent_no_US = 2
controlepoch = 100
training = 0
...
# Data loader===============================================================================================
    ...
    for ID in FinalIDs_train:
        ...
        if test%200 == 0:
            print(test)
        frac_map_image, timeseries_image, label_image, ID = create_frac_map_and_label_v2(ID,train_label_load)     
...
for ID in IDS:
    ...
    frac_map_image, timeseries_image, label_image, ID = create_frac_map_and_label_v2(ID,test_label_load)            
