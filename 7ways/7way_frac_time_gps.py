...
batch_size = 64
mode = 0
Model_Dir = '/home/kumarv/pravirat/Realsat_labelling/river_code_kx/Model/7way_frac_time_gps_add/'
continent_no_ASIA = 1
continent_no_US = 2
controlepoch = 100
continents = [1,2]
...
class Temp_CNN_simple(torch.nn.Module):
    ...
    def forward(self,x,y,t):
        ...
        # print('lstm_enc')
        # print(lstm_enc.shape)
        # print('lstm_enc_2')
        # print(lstm_enc_2[0].shape)

        # print("lstm")
        # print(lstm_enc_last.shape)
        ...
        # enc_concat = torch.cat([fc_1, fc_2, lstm_enc_last], dim=1) # concatenating the encodings
...
def create_frac_map_and_label_v2(ID,label_array):
    ...
    gps_map = np.load('/home/kumarv/pravirat/Realsat_labelling/GPS_IMAGE_NPY/'+ strID +'.npy')
...
# Data loader===============================================================================================
    ...
    for ID in thisround_train:
        ...
        if test%200 == 0:
            print(test)
        frac_map_image, timeseries_image, gps_image, label_image, ID = create_frac_map_and_label_v2(ID,train_label)     
    ...
    data_train = CLASSIFIER(frac_map_images_list_train, timeseries_images_list, gps_image_list_train, label_images_list_train, thisround_train)
...
for ID in IDS:
    ...
    frac_map_image, timeseries_image, gps_image, label_image, ID = create_frac_map_and_label_v2(ID,test_label)            
