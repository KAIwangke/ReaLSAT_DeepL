...
Model_Dir = '/home/kumarv/wan00802/models/resnet50_sameasRiver_1400/'
...
runcounter = othertotal/len(TrainRiver)
...
while(training):
    ...
    if(len(trainother)<otherlen):
        ...
        writer = pd.ExcelWriter(Model_Dir+'finished.xlsx', engine='xlsxwriter')
